    ...
    <div class="container">
        ...
        <div class="dirt-section">
            ...
            <div class="minecraft-title">
                <div class="title-text">GEGENSTAND HINZUFÜGEN</div>
                <div class="subtitle">Erweitere dein Inventar</div>
            </div>
            ...
            <form action="" method="POST">
                <div class="form-group">
                    <label for="id" class="form-label">Gegenstand:</label>
                ...
                <div class="form-group">
                    ...
                    <input id="Anzahl" name="Anzahl" type="number" min="1" class="form-input" required>
                </div>

                <button type="submit" class="minecraft-btn">Hinzufügen</button>
            </form> 
            ...
            <?php if ($userItemsResult->num_rows > 0): ?>
                <h2 style="font-size: 12px; color: #FFD700; text-shadow: 2px 2px 0 #B8860B; margin: 20px 0 15px 0;">Deine gespeicherten Gegenstände</h2>
                <ul class="inventory-list">
                    <?php while ($row = $userItemsResult->fetch_assoc()): ?>
                        <li class="inventory-item"><?= htmlspecialchars($row['name']) ?>: <?= (int)$row['Anzahl'] ?></li>
                    <?php endwhile; ?>
                </ul>
            <?php else: ?>
                <p style="color: #FFD700; font-size: 8px; text-shadow: 1px 1px 0 #B8860B; margin-top: 20px;">Du hast noch keine Gegenstände gespeichert.</p>
            <?php endif; ?>
        </div>
    </div>
</body>
