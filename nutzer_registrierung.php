    ...
    <div class="container">
        ...
        <div class="dirt-section">
            ...
            <div class="minecraft-title">
                <div class="title-text">REGISTRIERUNG</div>
                <div class="subtitle">Erstelle deinen Account</div>
            </div>
            ...
            <form method="POST">
                ...
                <button type="submit" class="minecraft-btn">Registrieren</button>
            </form>

            <!-- Login button -->
            <form action="nutzer_login.php" method="get">
                <button type="submit" class="minecraft-btn secondary-btn">Zum Login</button>
            </form>
        </div>
    </div>
</body>
