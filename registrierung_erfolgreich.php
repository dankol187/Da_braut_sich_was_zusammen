    ...
    <div class="container">
        ...
        <div class="dirt-section">
            ...
            <div class="minecraft-title">
                <div class="title-text">REGISTRIERUNG ERFOLGREICH</div>
                <div class="subtitle">Willkommen im Spiel</div>
            </div>

            <!-- Success message -->
            <p class="success-message">Vielen Dank für deine Registrierung.</p>
            
            <!-- User data -->
            <h3 style="font-size: 10px; color: #FFD700; text-shadow: 1px 1px 0 #B8860B; margin-bottom: 15px;">Deine Daten:</h3>
            <ul class="user-data">
            ...
            <form action="suche.php" method="get">
                <button class="minecraft-btn" type="submit">Zurück zur Suche</button>
            </form>
        </div>
    </div>
</body>
