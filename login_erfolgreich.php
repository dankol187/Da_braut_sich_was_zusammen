    ...
    <div class="container">
        ...
        <div class="dirt-section">
            ...
            <div class="minecraft-title">
                <div class="title-text">ANMELDUNG ERFOLGREICH</div>
                <div class="subtitle">Willkommen zurück</div>
            </div>

            <!-- Success message -->
            <p class="success-message">Vielen Dank für deine Anmeldung.</p>
            ...
            <form action="suche.php" method="get">
                <button class="minecraft-btn" type="submit">Zur Suche</button>
            </form>
        </div>
    </div>
</body>
